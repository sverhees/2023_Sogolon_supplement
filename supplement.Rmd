...
bot <- read_tsv("botlikhstrategies.csv")

## Avar narrative strategies
av <- read_tsv("avarstrategies.csv")

## Text sample folklore anthology with languages and locations
all <- readxl::read_xlsx("svod_content.xlsx")
...
* An overview of the text sample with a short synopsis of each text
...
The sheperd Surxaj from Šodroda (a nearby Avar village) goes to fetch water late in the evening after he has driven the cattle into the stable. He encounters a huge being dressed in rags and tries to chase it away by sending ferocious dogs and throwing rocks. Next, he loses consciousness for several days. When he wakes up he cannot move. The elders of the village decide that he must have met the mother of illnesses, who made him sick because he threw rocks at her.
